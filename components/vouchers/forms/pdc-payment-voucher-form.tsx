...
function emptyLine() {
  return { accountId: "", chequeNo: "", chequeDate: today(), dueDate: "", amount: blankAmount, rentMonth: "", remarks: "" };
}
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
        ...
        <FormSection
          ...
          description="Header details for this PDC payment voucher."
          icon={FileTextIcon}
        >
        ...
        <div className="flex items-center justify-end gap-2 border-t pt-4">
          <Button type="button" variant="outline" asChild>
            <Link href="/accounting/vouchers/pdc_payment_voucher">Cancel</Link>
          </Button>
